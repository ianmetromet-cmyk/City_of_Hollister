...
PHOTOS = [
    ...
    ("water-diego-hydrant",
     os.path.join(WATER_JJ, "IMG_1100.JPG"),
     (0.0, 0.02, 1.0, 0.98), 18, 252, 1.00, 1.04),
    ("water-curb-paint",
     os.path.join(WATER_JJ, "IMG_1093.JPG"),
     (0.05, 0.0, 1.0, 1.0), 14, 250, 1.00, 1.05),
    ("water-hydrant-hands",
     os.path.join(WATER_JJ, "IMG_1122.JPG"),
     (0.0, 0.05, 1.0, 1.0), 16, 250, 1.00, 1.04),
    ("water-rodrigo-flush",
    ...
    ("water-hydrant-jet",
     os.path.join(WATER_RJ, "IMG_1066.JPG"),
     (0.0, 0.05, 1.0, 1.0), 18, 252, 1.00, 1.03),
    ("storm-seiu-vactor",
